...
export default function HappyHour() {
  ...
  return (
    ...
    >
      ...
      <Typography level="h4" component="h3" id="issues" className="styling-h3" sx={{
        ml: 1,
      }}>Known issues</Typography>
      <List size="sm"
      sx={{
        ml:2
      }}>
      ...
      <Typography level="h4" component="h3" id="future" className="styling-h3" sx={{
        ml: 1,
      }}>
        Future improvements
      </Typography>
