...
import { Container, Typography, Divider, List, ListItemButton, ListItemIcon, ListItemText, ListSubheader, Link } from '@mui/material';
        ...
        <>
            <Container sx={{ padding: '10px' }}>
                <Typography variant="h1">The Poke-Dex</Typography>
                        ...
                        <Divider sx={{margin: '2rem 0'}} />
                            <Typography variant="h2" id="overview">I. Overview</Typography>
                        ...
                        <Divider sx={{margin: '2rem 0'}} />
                            <Typography variant="h2" id="gettingStarted">II. Getting started</Typography>
